...
\newcommand{\costref}[1]{Specification~[\ref{cost:#1}]}
...
\newcommand{\itemreftwo}[2]{Items~[\ref{item:#1} and~\ref{item:#2}]}
...
% \newcommand{\ccomment}[1]{\text{\unicode{8284}~\text{#1}}}
...
\newcommand{\argmax}[2]{\mathbf{arg\,max\,}_{#1} \left( {#2} \right)}
...
\newcommand{\visit}{visit}   %% as in visit time
\newcommand{\visittime}{\mathcal{T}}   %% as in visit time
\newcommand{\finishtime}{\mathcal{U}}   %% as in visit time
